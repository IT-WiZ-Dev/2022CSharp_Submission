...
namespace Fishing
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            iwashi = new Iwashi(x, y, IwashiSpeed, formSizeW, pictureBox1);
            x = pictureBox2.Location.X;
            y = pictureBox2.Location.Y;
            utubo = new Utubo(x, y, UtuboSpeed, formSizeW, pictureBox2);
        ...
        private void Form1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                score += iwashi.Esa(int.Parse(e.KeyChar.ToString()), pictureBox3);
                score += utubo.Esa(int.Parse(e.KeyChar.ToString()), pictureBox4);
                score += ankou.Esa(int.Parse(e.KeyChar.ToString()), pictureBox6);
